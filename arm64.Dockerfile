...
RUN set -eux; \
  ...
  GCC_LIBS_URL="http://tardis.tiny-vps.com/aarm/packages/g/gcc-libs/gcc-libs-10.2.0-1-arm.pkg.tar.xz"; \
  ZLIB_URL="http://tardis.tiny-vps.com/aarm/packages/z/zlib/zlib-1%3A1.2.11-5-arm.pkg.tar.xz"; \
